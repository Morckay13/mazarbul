 ...
 * Use the [DescripcionSubrazaFragment.newInstance] factory method to
...
class DescripcionSubrazaFragment : Fragment() {
    ...
    companion object {
         ...
         * @return A new instance of fragment DescripcionSubrazaFragment.
         */
        // TODO: Rename and change types and number of parameters
        @JvmStatic
        fun newInstance(param1: String, param2: String) =
            DescripcionSubrazaFragment().apply {
