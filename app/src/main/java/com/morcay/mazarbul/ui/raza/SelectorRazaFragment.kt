 ...
 * Use the [SelectorRazaFragment.newInstance] factory method to
...
class SelectorRazaFragment : Fragment() {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        val razas = listOf("Humano", "Elfo", "Enano", "Gnomo", "Mediano", "Orco")
    ...
    companion object {
         ...
         * @return A new instance of fragment SelectorRazaFragment.
         */
        // TODO: Rename and change types and number of parameters
        @JvmStatic
        fun newInstance(param1: String, param2: String) =
            SelectorRazaFragment().apply {
